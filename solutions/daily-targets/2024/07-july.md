...
&lt;style&gt;
  * {
  ...
  div {
    height: 200px;
    width: 200px;
    background: linear-gradient(#4F77FF 0 50%,#EFF8FE 0);
    border-radius: 100%;
    &::after {
      content: "";
      display: block;
...
<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_0rXsdA4.png?alt=media">
